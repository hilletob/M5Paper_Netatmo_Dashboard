...
- **Weather Forecast**: 3-day forecast from met.no (yr.no) API
- **Gemini AI Widget**: Funny weather commentary generated by Google Gemini AI
...
┌────────────────────────────────────────────┐
│ INDOOR              │ OUTDOOR              │
│ Temperature 23.5°C ↑│ Temperature 12.3°C ↓ │
│ Humidity 45%        │ Humidity 65%         │
│ CO2 850ppm ↓        │ AI: "Draussen kalt,  │
│ Pressure 1015hPa →  │ drinnen gemuetlich!" │
├─────────────────────┼──────────────────────┤
│ 3-DAY FORECAST (met.no API)                │
...
**Widget Highlights**:
- Indoor section: Temp, Humidity, CO2 (with calculated trend), Pressure
- Outdoor section: Temp, Humidity (from Netatmo outdoor module)
- AI Widget: Gemini-generated weather commentary (replaces Wind/Rain)
- 3-day forecast: Daily min/max temps from met.no API
...
- **Response**: Dry-humorous German weather commentary (max 140 chars)
